...
!function (t, i) {
    ...
    var di, pi, mi, fi, gi = i({}, ci, {
        ...
        Pi = B("webkit"), bi = B("android"), Ti = B("android 2") || B("android 3"), zi = !!window.opera,
        Mi = B("chrome"), Ci = B("gecko") && !Pi && !zi && !xi, Zi = !Mi && B("safari"), Ei = B("phantom"),
        ...
        Ri = "undefined" != typeof orientation || B("mobile"), Di = Ri && Pi, Ni = Ri && Ii,
    ...
    var me, fe, ge = (Object.freeze || Object)({
        ...
        getBoundsZoom: function (t, i, e) {
            ...
            var n = this.getZoom() || 0, o = this.getMinZoom(), s = this.getMaxZoom(), r = t.getNorthWest(),
                ...
                u = b(this.project(a, n), this.project(r, n)).getSize(), l = Oi ? this.options.zoomSnap : 1,
